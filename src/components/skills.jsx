    ...
    return (
        ...
        >
            <img
                src={skill.icon}
                alt={`${skill.name} logo`}
                className="h-16 w-16 grayscale opacity-60 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-300"
    ...
    return (
        <section id="skills" className="py-24 bg-gray-50 dark:bg-gray-900">
            <div className="container mx-auto px-6">
                <h2 className="text-4xl font-bold text-center mb-12 text-gray-900 dark:text-white font-display">
                    Tech Stack
                </h2>
                <motion.div
